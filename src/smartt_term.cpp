...
const SmarttTerm AUTONOMOUS_AGENT_NAME("autonomous_agent_name");
...
const SmarttTerm BMEF_CONTRACTS_LIMIT("bmef_contracts_limit");
const SmarttTerm BMEF_MINI_CONTRACTS_LIMIT("bmef_mini_contracts_limit");
const SmarttTerm BOVESPA_FINANCIAL_VOLUME_LIMIT("bovespa_financial_volume_limit");
...
const SmarttTerm DATETIME2("datetime2");
const SmarttTerm DATETIME3("datetime3");
...
const SmarttTerm FINAL_DATETIME2("final_datetime2");
const SmarttTerm FINAL_DATETIME3("final_datetime3");
...
const SmarttTerm INCLUDE_EXTERNAL_ORDERS("include_external_orders");
...
const SmarttTerm IS_ALREADY_KNOWN("is_already_known");
const SmarttTerm IS_ALREADY_USING("is_already_using");
...
const SmarttTerm IS_PLAYABLE("is_playable");
...
const SmarttTerm MARKET_NAME2("market_name2");
...
const SmarttTerm NUMBER_OF_CONTRACTS_TRADED_ON_BMF("number_of_contracts_traded_on_bmf");
...
const SmarttTerm NUMBER_OF_MINIS_TRADED_ON_BMF("number_of_minis_traded_on_bmf");
const SmarttTerm NUMBER_OF_ORDERS("number_of_orders");
const SmarttTerm NUMBER_OF_ORDERS_EVENTS("number_of_orders_events");
const SmarttTerm NUMBER_OF_ORDERS_EXECUTED_ON_BOVESPA("number_of_orders_executed_on_bovespa");
const SmarttTerm NUMBER_OF_ROBOTS_LIMIT("number_of_robots_limit");
...
const SmarttTerm ONLY_PENDING("only_pending");
...
const SmarttTerm ORDER_IDS("order_ids");
...
const SmarttTerm SENT_BY_INSERT_EXTERNAL_ORDER("sent_by_insert_external_order");
const SmarttTerm SENT_BY_RESET_PORTFOLIO("sent_by_reset_portfolio");
...
const SmarttTerm STOCK_CODE2("stock_code2");
const SmarttTerm STOCK_CODE3("stock_code3");
...
const SmarttTerm STOP_ORDER_IDS("stop_order_ids");
...
const SmarttTerm VALUE2("value2");
