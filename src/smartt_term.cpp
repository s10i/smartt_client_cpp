...
const SmarttTerm ADJUSTMENT_FACTOR("adjustment_factor");
...
const SmarttTerm CBLC_LOGIN("cblc_login");
const SmarttTerm CITY("city");
const SmarttTerm CLOSE("close");
...
const SmarttTerm DELETE_FAKE_TRADES_MESSAGE("delete_fake_trades_message");
...
const SmarttTerm FIFTEEN("fifteen");
...
const SmarttTerm FIRST_TRADE_DATETIME("first_trade_datetime");
const SmarttTerm FIRST_TRADE_IDENTIFIER("first_trade_identifier");
const SmarttTerm FIVE("five");
...
const SmarttTerm HIGH("high");
const SmarttTerm HOUR("hour");
const SmarttTerm HUNG("hung");
const SmarttTerm HUNG_CANCELLABLE("hung_cancellable");
const SmarttTerm HUNG_PENDING("hung_pending");
const SmarttTerm ID_BUYER_BROKERAGE("id_buyer_brokerage");
const SmarttTerm ID_SELLER_BROKERAGE("id_seller_brokerage");
const SmarttTerm IGNORE("ignore");
const SmarttTerm INCLUDE_AFTER_MARKET("include_after_market");
...
const SmarttTerm INSERT_CLIENT_MESSAGE("insert_client_message");
const SmarttTerm INSERT_FAKE_TRADE_MESSAGE("insert_fake_trade_message");
const SmarttTerm INVESTMENT_CODE("investment_code");
const SmarttTerm IS_AFTER_MARKET("is_after_market");
...
const SmarttTerm LAST_TRADE_DATETIME("last_trade_datetime");
const SmarttTerm LAST_TRADE_IDENTIFIER("last_trade_identifier");
const SmarttTerm LEASE_TAX("lease_tax");
const SmarttTerm LICENSE_EXPIRATION_DATE("license_expiration_date");
const SmarttTerm LICENSE_TYPE("license_type");
...
const SmarttTerm MAXIMUM_NUMBER_OF_CANDLES("maximum_number_of_candles");
const SmarttTerm MAXIMUM_NUMBER_OF_TRADES("maximum_number_of_trades");
...
const SmarttTerm ONE("one");
const SmarttTerm OPEN("open");
...
const SmarttTerm PERIODICITY("periodicity");
const SmarttTerm PLAN("plan");
const SmarttTerm PLAN_EXPIRATION_DATE("plan_expiration_date");
const SmarttTerm PLAN_EXPIRATION_DATETIME("plan_expiration_datetime");
...
const SmarttTerm TEN("ten");
const SmarttTerm THIRTY("thirty");
...
const SmarttTerm TRADE_IDENTIFIER("trade_identifier");
